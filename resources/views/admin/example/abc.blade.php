...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('public_view')}}/assets/images/favicon.ico" type="image/x-icon">

    <!-- prism css -->
    <link rel="stylesheet" href="{{asset('public_view')}}/assets/css/plugins/prism-coy.css">
    <!-- vendor css -->
    <link rel="stylesheet" href="{{asset('public_view')}}/assets/css/style.css">
...
<body>
        ...
        <div class="container">
            <div class="m-header">
                ...
                <a href="#!" class="b-brand">
                    ...
                    <img src="{{asset('public_view')}}/assets/images/logo.png" alt="" class="logo">
                    <img src="{{asset('public_view')}}/assets/images/logo-icon.png" alt="" class="logo-thumb">
                </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right notification">
                                ...
                                <ul class="noti-body">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="{{asset('public_view')}}/assets/images/user/avatar-1.jpg" alt="Generic placeholder image">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="{{asset('public_view')}}/assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                    ...
                    <li>
                        <div class="dropdown drp-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-notification">
                                <div class="pro-head">
                                    <img src="{{asset('public_view')}}/assets/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
    ...
    <!-- [ Main Content ] end -->
                    ...
                    <ul class="iew-download">
                        <li>
                            <a href="http://www.google.com/chrome/">
                                <img src="{{asset('public_view')}}/assets/images/browser/chrome.png" alt="Chrome">
                                <div>Chrome</div>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.mozilla.org/en-US/firefox/new/">
                                <img src="{{asset('public_view')}}/assets/images/browser/firefox.png" alt="Firefox">
                                <div>Firefox</div>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.opera.com">
                                <img src="{{asset('public_view')}}/assets/images/browser/opera.png" alt="Opera">
                                <div>Opera</div>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.apple.com/safari/">
                                <img src="{{asset('public_view')}}/assets/images/browser/safari.png" alt="Safari">
                                <div>Safari</div>
                            </a>
                        </li>
                        <li>
                            <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                                <img src="{{asset('public_view')}}/assets/images/browser/ie.png" alt="">
                                <div>IE (11 & above)</div>
                            </a>
                        </li>
                    </ul>
        ...
        <!-- Required Js -->
        <script src="{{asset('public_view')}}/assets/js/vendor-all.min.js"></script>
        <script src="{{asset('public_view')}}/assets/js/plugins/bootstrap.min.js"></script>
        <script src="{{asset('public_view')}}/assets/js/pcoded.min.js"></script>


    <!-- prism Js -->
    <script src="{{asset('public_view')}}/assets/js/plugins/prism.js"></script>





    <script src="{{asset('public_view')}}/assets/js/horizontal-menu.js"></script>
    <script>
        (function() {
    ...
    <script src="{{asset('public_view')}}/assets/js/analytics.js"></script>
