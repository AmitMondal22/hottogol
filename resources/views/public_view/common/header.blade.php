        ...
        <div class="container">
            <div class="m-header">
                ...
                <a href="#!" class="b-brand">
                    ...
                    <img src="{{asset('public/public_view')}}/assets/images/logo.png" alt="" class="logo">
                    <img src="{{asset('public/public_view')}}/assets/images/logo-icon.png" alt="" class="logo-thumb">
                </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right notification">
                                ...
                                <ul class="noti-body">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="{{asset('public/public_view')}}/assets/images/user/avatar-1.jpg" alt="Generic placeholder image">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="{{asset('public/public_view')}}/assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                    ...
                    <li>
                        <div class="dropdown drp-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-notification">
                                <div class="pro-head">
                                    <img src="{{asset('public/public_view')}}/assets/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
